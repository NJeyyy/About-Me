...
async function Startonlyonvideopage() {
  ...
  }), {once: !0}), ISE(".view-count.ytd-video-view-count-renderer").setAttribute("title", ISE("div#info-strings yt-formatted-string.ytd-video-primary-info-renderer").textContent), document.location.href.match(/&list=/) && (ISE("video").onplay = t => {
    var e = t.path[0], o = e.duration - 0.15;
    e.currentTime >= o && (e.pause(), e.currentTime = o, e.onplay = n => {
      e.currentTime >= o && (e.pause(), e.currentTime = o, console.error(t.path[0].currentTime), console.warn("This video was about to end... Moreover, it seems that your video was shown in a playlist.\nSo... it's best to stop here to not proceed to the next video without your consent."));
    });
  }), sessionStorage.setItem("AlreadyRUN_YTOptionalFunction1", !0), console.log("DONE! that's script that's only run in video page!")) : console.log("This script is not working here =w="), await sleep(50);
}
