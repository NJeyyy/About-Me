...
async function Startonlyonvideopage() {
  ...
  }), {once: !0}), ISE(".view-count.ytd-video-view-count-renderer").setAttribute("title", ISE("div#info-strings yt-formatted-string.ytd-video-primary-info-renderer").textContent), ISE("video").onplay = e => {
    var t = e.path[0], n = t.duration - .15;
    t.currentTime == t.currentTime && (t.pause(), t.currentTime = n, t.onplay = o => {
      t.currentTime >= t.currentTime && (t.pause(), t.currentTime = n, console.error(e.path[0].currentTime), console.warn("This video was about to end... Moreover, it seems that your video was shown in a playlist.\nSo... it's best to stop here to not proceed to the next video without your consent."))
    })
